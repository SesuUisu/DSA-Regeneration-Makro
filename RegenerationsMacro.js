//Nächtliche Regeneration v0.8.4
/**
...
async function main() {
    ...
    if (schlafstorung) {
        ...
        schlafstorungRoll.then(roll => {
            ...
            let insomniaDialogOutput = " " + schlafstorungValue + "<span style='color:#888;'> w20: " + rollStorungValue + "</span>";
            ...
            accept: {
                ...
                callback: (html) => {
                    ...
                    bigRoll.then(roll => {
                        ...
                        const message = headerMessage + physMessage + astraMessage + karmicMessage + enduMessage;
